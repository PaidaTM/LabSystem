                ...
                <td>
                    <table width="100%" height="300px;">
                        ...
                        <tr>
                            ...
                            <%--                                <div ><input class="editbox"  name="createddate"> </div>--%>
<%--                                <script>--%>
<%--                                    var date = new Date();--%>
...
<%--                                </script>--%>
                        ...
                        <tr hidden="hidden">
                            ...
                            <td><input class="editbox" type="text" name="creatorid" value="${loginUser.userid}"
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="editbox" type="text" name="status">
                        ...
                        <tr>
                            ...
                            <td><input class="editbox" type="text" name="number" value="${device.number}"></td>
                        </tr>

                        <tr>
                            <td class="s1" style="width:120px">UNIT PRICE</td>
                            <td><input class="editbox" type="text" name="unitprice" value="${device.unitprice}"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="eqid" value="${equipment.eqid}" hidden="hidden">
                            </td>
                        </tr>
                        <tr>
                        <tr hidden="hidden">
                            <td><input class="editbox" type="text" name="updaterid" value="0"></td>
                        </tr>
