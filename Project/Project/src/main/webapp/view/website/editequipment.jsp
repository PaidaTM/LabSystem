                ...
                <td>
                    <table width="100%" height="300px;">
                        ...
                        <tr hidden="hidden">
                            ...
                            <td><input class="editbox" readonly="readonly"  name="createddate" value="${equipment.createddate}">
                            </td>
                        </tr>
                        <tr>
                            <td class="s1" style="width:120px">UPDATION DATE</td>
                            <td>
                        ...
                        <tr hidden="hidden">
                            ...
                            <td><input class="editbox" type="text" name="creatorid" value="${equipment.creatorid}" readonly="readonly"></td>
                        </tr>
                        ...
                        <tr hidden="hidden">
                            ...
                            <td><input class="editbox" type="text" name="type" value="${equipment.type}"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <script>
                                    if (${equipment.labid}=1){
                                        ${equipment.labname}="Chemistry Laboratory";
                                    }else if(${equipment.labid}=2){
                                        ${equipment.labname}="Physic Laboratory"
                                    }
                                </script>
                            </td>
                        </tr>
