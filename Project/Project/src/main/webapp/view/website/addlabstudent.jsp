...
<head>
    ...
    <!--end of page css-->
    <meta charset="utf-8">
    <title>Register Laboratory Student</title>
...
<div style="margin-top: 100px; ">
    <center>
        ...
        <form action="../../usermanage/addlabstudent" method="post">
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="editbox" name="firstname"></td>
                                </tr>
                                <tr>
                                    <td style="padding-left: 20px;">LAST NAME</td>
                                    <td><input type="text" class="editbox" name="lastname"></td>
                                </tr>
                                <tr>
